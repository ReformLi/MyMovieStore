 ...
 */
class ChongchongVideoSource(
    client: OkHttpClient = defaultClient(),
    cacheRepository: ApiCacheRepository? = null,
    rateLimiter: RequestRateLimiter = RequestRateLimiter("CHCH", 3_000L, 3)
) : CrawlerVideoSource(client, cacheRepository, rateLimiter) {

    override val sourceId = "crawler_chongchong"
    override val cachePrefix = "chongchong"
    override val rateLimiterTag = "CHCH"
    override val logTag = "ChongchongVideoSource"
